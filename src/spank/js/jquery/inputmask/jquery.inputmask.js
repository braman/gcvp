...
(function ($) {
    if ($.fn.inputmask == undefined) {        $.inputmask = {
            ...
            defaults: {
                ...
                autoUnmask: true, //automatically unmask when retrieving the value with $.fn.val or value if the browser supports __lookupGetter__ or getOwnPropertyDescriptor
