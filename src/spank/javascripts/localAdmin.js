...
//    	XmppClient.send("queue",JSON.stringify({action:"loadGroup",group:_group}));
    ...
    function onConnect() {       
        XmppClient.send("queue","initLocalAdmin");
    }
    ...
    function _onMessage(text){
        ...
        console.log(msg1);
        console.log("----------------"+msg1.group);
        if(msg1.group){
        	selectedGroup = msg1.group;
        }        
        if(msg1.username){
    ...
    function goToMonitor() {
    	...
    	jQuery("#body").load("monitor.html", function(html) {
    		if (typeof _init == "function") {
    			_initFromLocalAdmin('ru');
    		}
    		jQuery("#body").show();
    	});
    }
